  ...
  const blog1 = [
    {
      ...
      small:"Taking the 'on the mat' practice and applying it within our every day routine - at work, at home, all over the world",
  ...
  const blog2 = [
    {
      ...
      small:"A few tips and tricks on how to benefit from yoga with a little extra care towards our mind and body!",
  ...
  return (
    <>
     <section  data-aos="fade-up"
        data-aos-once="true" className="md:container md:mx-auto">
