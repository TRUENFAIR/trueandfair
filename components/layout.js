  ...
  return (
    <>
      ...
      <footer className='border-zinc-100 border-t mx-auto container py-12'>
        <div className='grid grid-cols-2 md:flex md:flex-row justify-between items-start text-center'>

          <div className='col-span-2 pb-4 md:pb-0'>
            <Link href="/">
              <a className="flex md:justify-start items-center justify-center">
          ...
          <div className='text-sm flex flex-col pb-4 md:pb-0'>
        ...
        <div className='mx-auto text-center text-sm text-zinc-400 pt-12'>
