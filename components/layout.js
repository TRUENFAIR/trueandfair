      ...
      <footer className='border-zinc-100 border-t mx-auto md:container py-6 md:py-12'>
        <div className='grid grid-cols-2 md:flex md:flex-row justify-between items-start'>
            ...
            <Link href="/">
              <a className="flex justify-start items-center pl-6 md:pl-0">
                ...
                <div className="pl-2 flex flex-col justify-center">
                  <span className="leading-4 font-light text-zinc-800 text-xl">Madhur Pharma</span>
                  <span className="text-zinc-800 font-light text-sm">
                    <span className="text-xs">&&nbsp;</span>Research Laboratories
                  </span>
                </div>
              </a>
            </Link>
          ...
          <div className='text-sm p-4 md:p-0 '>
            ...
            <p className=''>+91-80-23720510</p>
            <p className=''>88616 99880</p>
          </div>
