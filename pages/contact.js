...
export default function Contact() {
  ...
  const sendMessage = async (e) => {
    ...
    const response = await fetch( "https://prejyihun6edtdi4tyfymegotm0sbtxi.lambda-url.ap-south-1.on.aws/", {
      method: 'POST',
      headers: {},
    ...
    if (response.status === 200) {
      ...
      setInterest("")
      setInfo("")
      setMessage("Your message is sent. We'll get back to you at the earliest!")
    } else {
            ...
            <div className="md:w-3/5 w-full">
                ...
                <div className="md:pl-12 md:pt-0 pt-12">
                  ...
                  <form className="mt-8" onSubmit={sendMessage}>
                    ...
                    {message ? (
                      <p className="text-green text-md font-semibold pt-6 ">{message}</p>
                    ): (
