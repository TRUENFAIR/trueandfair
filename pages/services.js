      ...
      <div className='md:container p-4 mx-auto'>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-24 gap-4 pt-12">
          ...
          <div className="w-auto">
            ...
            <p className="pt-6 prose">With the right blend of expertise and experience, we have helped several customers develop and deliver a wide range of products in the global market, with our manufacturing infrastructure as the backbone. Get in touch to know more.</p>
          </div>
          ...
          <div className="w-auto">
            ...
            <p className="pt-6 prose">When you partner with us, quality and on-time delivery are always guaranteed, whether the order is big or small. Get in touch to know more.</p>
          </div>
