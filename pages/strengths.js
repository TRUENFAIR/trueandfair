        ...
        <div className="grid grid-cols-2 gap-16 pt-12">
          ...
          <div className="w-auto relative">
            <div className="relative w-[95%] h-64 flex justify-start items-end shadow-sm hover:scale-[1.02] transition-all cursor-pointer">
              ...
              <h1 className="text-3xl tracking-wide drop-shadow-lg font-semibold  text-white z-10 w-full p-4">R&D</h1>
            </div>
          ...
          <div className="w-auto relative">
            <div className="relative w-[95%] h-64 flex justify-start items-end shadow-sm hover:scale-[1.02] transition-all cursor-pointer">
              ...
              <div className="absolute inset-0 bg-black opacity-40"></div>
              <h1 className="text-3xl tracking-wide drop-shadow-lg font-semibold  text-white z-10 w-full p-4">QUALITY</h1>
            </div>
          ...
          <div className="w-auto relative">
            <div className="relative w-[95%] h-64 flex justify-start items-end shadow-sm hover:scale-[1.02] transition-all cursor-pointer">
              ...
              <div className="absolute inset-0 bg-black opacity-40"></div>
              <h1 className="text-3xl tracking-wide drop-shadow-lg font-semibold  text-white z-10 w-full p-4">FLEXIBILITY</h1>
            </div>
          ...
          <div className="w-auto relative">
            <div className="relative w-[95%] h-64 flex justify-start items-end shadow-sm hover:scale-[1.02] transition-all cursor-pointer">
              ...
              <div className="absolute inset-0 bg-black opacity-40"></div>
              <h1 className="text-3xl tracking-wide drop-shadow-lg font-semibold  text-white z-10 w-full p-4">TECHNOLOGY</h1>
            </div>
